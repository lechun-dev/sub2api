...
func ProvideAdminHandlers(
	...
	apiKeyIssuanceHandler *admin.AdminAPIKeyIssuanceHandler,
	...
	return &AdminHandlers{
		...
		APIKeyIssuance:         apiKeyIssuanceHandler,
...
var ProviderSet = wire.NewSet(
	...
	admin.NewAdminAPIKeyIssuanceHandler,
	wire.Bind(new(service.APIKeyCreator), new(*service.APIKeyService)),
